...
export function AdventureAvatar() {
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center gap-4 min-h-[300px]">
      ...
      {/* Mobile Layout: Avatar on top, controls below */}
      {isMobile ? (
        <div className="flex flex-col items-center justify-center w-full h-full gap-4 md:gap-6 z-10 px-4">
          {/* Avatar Container - Top on mobile */}
          <motion.div
                  ...
                  {currentAdventure.type === "surfing" && (
                    <g>
                      ...
                      >
                        ...
                        {/* Wetsuit detail */}
                        <path d="M 112 105 L 120 110 L 125 120" stroke="#FFF" strokeWidth="1.5" fill="none" opacity="0.5" />
          ...
          {/* Mobile Controls Container - Below avatar */}
          <div className="flex flex-col items-center gap-4 w-full max-w-md">
            ...
            >
              <div className="inline-flex items-center gap-3 bg-white/20 backdrop-blur-md rounded-2xl px-5 py-3 border border-white/30 shadow-[0_8px_32px_rgba(0,0,0,0.1)]">
                <currentAdventure.icon className="w-5 h-5 text-white" strokeWidth={2.5} />
                <div className="text-left">
                  <p className="text-white font-semibold text-base leading-tight">{currentAdventure.label}</p>
                  <p className="text-white/70 text-sm leading-tight">{currentAdventure.sublabel}</p>
                </div>
              </div>
            </motion.div>

            {/* Adventure Buttons */}
            <div className="flex flex-wrap gap-2 justify-center w-full max-w-[280px]">
            ...
            <AnimatePresence>
              {currentAdventureIndex === 0 && (
                ...
                >
                  👆 Tap avatar to cycle adventures!
                </motion.p>
              )}
            </AnimatePresence>
          </div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                >
                  ...
                  {/* All adventure type SVG graphics remain exactly as they were */}
                  {/* Rock Climbing - Enhanced */}
                  {currentAdventure.type === "climbing" && (
                    <g>
                      {/* Mountain/Rock Wall with gradient */}
