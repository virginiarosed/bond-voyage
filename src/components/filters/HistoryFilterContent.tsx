...
interface HistoryFilterContentProps {
  ...
  onCompletedDateFromChange: (value: string) => void;
  completedDateTo: string;
  onCompletedDateToChange: (value: string) => void;
  minAmount: string;
...
export function HistoryFilterContent({
  ...
  onDateToChange,
  completedDateFrom,
  onCompletedDateFromChange,
  completedDateTo,
  onCompletedDateToChange,
  minAmount,
  onMinAmountChange,
  maxAmount,
  onMaxAmountChange,
    ...
    <>
      <div className="p-5 bg-gradient-to-br from-[#F8FAFB] to-white border-b border-[#E5E7EB]/50">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-[#1A2B4F]">Filter History</h3>
      ...
      <div className="p-5 space-y-4 max-h-[500px] overflow-y-auto">
        ...
        <div>
          ...
          <div className="space-y-3">
            <div>
              <Label htmlFor="completed-date-from" className="text-xs text-[#64748B] mb-1.5 block">
                From
              </Label>
              <Input
                ...
                onChange={(e) => onCompletedDateFromChange(e.target.value)}
                className="h-11 border-[#E5E7EB] focus:border-[#0A7AFF] focus:ring-[#0A7AFF]/10"
              />
            </div>
            <div>
              <Label htmlFor="completed-date-to" className="text-xs text-[#64748B] mb-1.5 block">
                To
              </Label>
              <Input
                ...
                onChange={(e) => onCompletedDateToChange(e.target.value)}
                className="h-11 border-[#E5E7EB] focus:border-[#0A7AFF] focus:ring-[#0A7AFF]/10"
              />
            </div>
          </div>
