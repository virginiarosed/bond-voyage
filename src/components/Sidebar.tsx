import { LayoutDashboard, Users, Calendar, CheckCircle, Archive, FileText, MessageSquare, MoreHorizontal, Bell, HelpCircle, X, ChevronRight, User, Star, Sun, Moon, Check } from "lucide-react";
...
export function Sidebar({ currentTheme, onThemeChange, isMobileMenuOpen, setIsMobileMenuOpen }: SidebarProps) {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center gap-1 mt-4">
        {menuItems.map((item) => {
          ...
          const isActive = location.pathname === item.id || 
            (item.id === "/itinerary" && location.pathname.startsWith("/itinerary"));
      ...
      <div className="mt-auto mb-3 flex flex-col items-center gap-2">
        ...
        >
          <MoreHorizontal className="w-5 h-5 text-sidebar-foreground/60" strokeWidth={2.5} />
        </button>
      ...
      {/* User Menu Overlay */}
      {showUserMenu && (
        <div ref={userMenuRef} className="fixed bottom-3 left-24 w-72 max-w-[calc(100vw-6rem)] bg-popover backdrop-blur-xl rounded-2xl shadow-[0_8px_32px_rgba(10,122,255,0.12),0_2px_8px_rgba(0,0,0,0.08)] border border-border z-[200] overflow-hidden">
          <div className="p-5 border-b border-border bg-gradient-to-br from-primary/5 to-accent/5">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground">admin@bondvoyage.com</p>
              </div>
            </div>
          </div>
      ...
      {showThemeMenu && (
        <div ref={themeMenuRef} className="fixed bottom-3 left-24 lg:left-[400px] w-80 max-w-[calc(100vw-6rem)] bg-popover backdrop-blur-xl rounded-2xl shadow-[0_8px_32px_rgba(10,122,255,0.12),0_2px_8px_rgba(0,0,0,0.08)] border border-border z-[200] overflow-hidden">
