import { LayoutDashboard, Users, Calendar, CheckCircle, Archive, FileText, MessageSquare, MoreHorizontal, Bell, HelpCircle, X, ChevronRight, User, Star, Sun, Moon, Check, ArrowLeftRight, LogOut } from "lucide-react";
          ...
          {showSideMenu && (
            <div className="absolute left-20 top-0 ml-3 w-56 bg-card border border-border rounded-xl shadow-lg overflow-hidden z-50 animate-in fade-in slide-in-from-left-2 duration-200">
              ...
              >
                ...
                <span className="text-sm text-card-foreground">Switch to User Side</span>
              </button>
            </div>
          )}
        </div>
        ...
        <div className="relative" ref={userMenuRef}>
          ...
          >
            {profileData.profilePicture ? (
              <img src={profileData.profilePicture} alt="Profile" className="w-full h-full object-cover rounded-[0px]" />
            ) : (
