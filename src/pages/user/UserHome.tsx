...
// Add this useEffect to handle scrolling to Contact section
useEffect(() => {
  if (location.state?.scrollToContact) {
    // Wait for the component to render, then scroll to Contact section
    setTimeout(() => {
      const contactSection = document.getElementById('contact-4bs-section');
      if (contactSection) {
        ...
        contactSection.style.animation = 'highlight-contact 2s ease-in-out';
  ...
  const handleSendEmail = async () => {
    ...
    try {
      ...
      const emailData = {
        to: "4bstravelandtours2019@gmail.com",
