              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                {currentBooking.bookingSource && (
                  <span className={`px-3 py-1.5 rounded-full text-xs font-medium border backdrop-blur-sm ${
                    currentBooking.bookingSource === "Generated"
                      ? "bg-[rgba(167,139,250,0.2)] border-[rgba(167,139,250,0.3)] text-white"
                      : "bg-[rgba(20,184,166,0.2)] border-[rgba(20,184,166,0.3)] text-white"
                  }`}>
                    {currentBooking.bookingSource === "Generated" ? "✨ AI Generated" : "🎨 Customized"}
                  </span>
                )}
              </div>
                    ...
                    <>
                      ...
                      {booking.bookingSource && (
                        <span className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium border ${
                          ...
                          {booking.bookingSource === "Customized" ? "✨" : "🤖"} {booking.bookingSource}
                        </span>
                      )}
                      {activeTab === "rejected" && (
                        <>
